...
// Add a type assertion to bypass TypeScript checks when needed
// You can use this pattern in components as needed:
// const { data, error } = await supabase.from('table').select('*') as { data: YourType[] | null, error: any };
